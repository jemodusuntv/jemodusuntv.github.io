...
const CONFIG = {
  ...
  platforms: [
    ...
    { name: "Facebook",  followers: 2100000,  color: "#1877f2",  bg: "#e8f0fe", icon: "fb" },
    { name: "TikTok",    followers: 904000,   color: "#000000",  bg: "#f0f0f0", icon: "tt" },
    { name: "Instagram", followers: 158000,   color: "#c13584",  bg: "#fce4f0", icon: "ig" },
  ],
